...
function claude_ai_scanner_add_admin_menu() {
    ...
    add_submenu_page(
        ...
        'Advanced Scan',
        'manage_options',
        'claude-ai-scanner-advanced',
        'claude_ai_scanner_advanced_page'
    );
...
function claude_ai_scanner_advanced_page() {
    if (!current_user_can('manage_options')) {
        wp_die('Unauthorized');
    }
    ...
    <div class="wrap">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px; margin-top: 30px;">
            ...
            <div style="background: white; padding: 20px; border-radius: 8px; border-left: 4px solid #0073aa;">
                ...
                <button id="scan-performance-detailed" class="button button-primary" style="width: 100%; padding: 10px;">
            ...
            <div style="background: white; padding: 20px; border-radius: 8px; border-left: 4px solid #dc3545;">
                ...
                <button id="scan-404-links" class="button button-primary" style="width: 100%; padding: 10px; background-color: #dc3545 !important; border-color: #dc3545 !important;">
                    Find Broken Links
                </button>
                <p style="font-size: 12px; color: #999; margin-top: 10px;">Crawls up to 500 URLs | ~3 minutes</p>
            </div>
            ...
            <div style="background: white; padding: 20px; border-radius: 8px; border-left: 4px solid #fd7e14;">
                ...
                <button id="scan-redirects" class="button button-primary" style="width: 100%; padding: 10px; background-color: #fd7e14 !important; border-color: #fd7e14 !important;">
                    Analyze Redirects
                </button>
                <p style="font-size: 12px; color: #999; margin-top: 10px;">Checks internal redirects | ~1 minute</p>
            </div>
            ...
            <div style="background: white; padding: 20px; border-radius: 8px; border-left: 4px solid #28a745;">
                ...
                <button id="scan-seo-range" class="button button-primary" style="width: 100%; padding: 10px; background-color: #28a745 !important; border-color: #28a745 !important;">
                    Run SEO Scan
                </button>
                <p style="font-size: 12px; color: #999; margin-top: 10px;">Analyzes published posts/pages | ~2 minutes</p>
            </div>
            ...
            <div style="background: white; padding: 20px; border-radius: 8px; border-left: 4px solid #6f42c1;">
                ...
                <p style="color: #666; font-size: 13px;">Scan external domain links for availability and quality.</p>
                <button id="scan-external-links" class="button button-primary" style="width: 100%; padding: 10px; background-color: #6f42c1 !important; border-color: #6f42c1 !important;">
                    Check External Links
                </button>
                <p style="font-size: 12px; color: #999; margin-top: 10px;">Verifies external URLs | ~3 minutes</p>
            </div>

            <!-- Full Site Analysis Card -->
            <div style="background: white; padding: 20px; border-radius: 8px; border-left: 4px solid #17a2b8;">
                <h3 style="margin-top: 0;">🎯 Full Analysis</h3>
                <p style="color: #666; font-size: 13px;">Run all scans at once with AI-powered recommendations.</p>
                <button id="scan-all-advanced" class="button button-primary" style="width: 100%; padding: 10px; background-color: #17a2b8 !important; border-color: #17a2b8 !important;">
                    Run Full Analysis
                </button>
                <p style="font-size: 12px; color: #999; margin-top: 10px;">Runs all scans | ~10 minutes</p>
            </div>
    ...
    <script>
        (function($) {
            // Performance scan
            $('#scan-performance-detailed').click(function() {
                runAdvancedScan('performance', $(this));
            });

            // 404 detection
            $('#scan-404-links').click(function() {
                runAdvancedScan('404', $(this));
            });

            // Redirect analysis
            $('#scan-redirects').click(function() {
                runAdvancedScan('redirects', $(this));
            });

            // SEO range
            $('#scan-seo-range').click(function() {
                runAdvancedScan('seo', $(this));
            });

            // External links
            $('#scan-external-links').click(function() {
                runAdvancedScan('external', $(this));
            });

            // Full analysis
            $('#scan-all-advanced').click(function() {
                runAdvancedScan('all', $(this));
            });

            function runAdvancedScan(scanType, $btn) {
                $btn.prop('disabled', true);
                const originalText = $btn.text();
                $btn.text('Scanning... This may take a few minutes');
                $('#advanced-results').html('<p style="color: #666;">🔍 Running ' + scanType + ' scan...</p>');
            ...
            function displayAdvancedResults(analysis) {
                const html = `
                    <div class="advanced-report" style="background: white; padding: 20px; border-radius: 8px; border-left: 4px solid #0073aa; margin-top: 20px;">
                        <h2>Advanced Scan Report</h2>
